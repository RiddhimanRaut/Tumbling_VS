...
# Object tracking using the Kernelised Correlation Filter. 
# Performance has been tested using MedianFlow, MIL, MOSSE.  
# KCF has provided better results as far as visual servoing is concerned. 
# The above code returns the centres of selected ROIs, which you can feed into the vs_ur5.py node.
...
# Publishers: 3_point_features (publishes feature points) // X,Y coordinates are in pixels, depth is in millimetres.
